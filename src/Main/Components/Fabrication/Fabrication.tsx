            ...
            <div className={cx("content")}>
                ...
                <div className={cx("home_content")}>
                    ...
                    <div className={cx("videos")}>
                        ...
                        <iframe className={cx("videos_item")} src="https://www.youtube.com/embed/y4fCbHMtvhc"
                        ...
                        <iframe className={cx("videos_item")} src="https://www.youtube.com/embed/Er49UHlEnI0"
                        ...
                        <iframe className={cx("videos_item")} src="https://www.youtube.com/embed/sBtuixpCZ_A"
